...
](https://dl.acm.org/doi/abs/10.1007/978-3-030-62576-4_15) [ProvSec 2020] - This papers poposed a private decision tree evalation protocol that uses a secure three-party computation (3PC) protocol over the ring with one corruption.
